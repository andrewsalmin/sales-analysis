...
## 🧩 Описание проекта
Данный проект яявляется демонстрационным.
...
## 📈 Ключевые выводы
* Продажи распределены равномерно между странами: США, Канада, Франция, Германия и Мексика занимают примерно по 20% общей выручки;
